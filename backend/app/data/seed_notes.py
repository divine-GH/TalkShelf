...
SEED_NOTES: list[tuple[str, str, str, str, str, str, str | None]] = [
    ...
    ("note", "技术", "bge-m3 embedding 模型",
     ...
     None),
    ("note", "技术", "SQLite FTS5 trigram 中文检索",
    ...
    ("note", "技术", "Windows 沙箱吞掉外部程序输出",
     ...
     None),
    ("note", "技术", "Python os.mkdir 0o700 目录 ACL 陷阱",
...
SEED_MATERIALS: list[tuple[str, str, str]] = [
    ...
    ("fetched_page", "https://zhidx.com/p/bge-m3",
     "bge-m3 由北京智源人工智能研究院（BAAI）发布，支持 100 多种语言的检索、分类、相似度任务，"
     "采用自学习多语言表示训练，在 MTEB 多语言排行榜位居前列。"),
    ("search_result", "https://www.deepseek.com/zh/news/native-search",
